...
---------------------------------------------------------------------------
--                                Trips                                  --
-- requires: SPONSOR_CONTACT, CITY, ACTIVITY_TYPE, TRANSIT, HOTEL --
---------------------------------------------------------------------------
...
---------------------------------------
--              Groups               --
-- requires: STUDENT, LEADER, FLIGHT, TRIP --
---------------------------------------
...
CREATE TABLE TRIPGROUP (
	...
	CONSTRAINT FK_GROUP_TRIP FOREIGN KEY (TripID)
		REFERENCES TRIP (TripID)
...
CREATE TABLE FLIGHT_GROUP_STUDENT (
	FlightGroupStudentID int IDENTITY(1,1) NOT NULL,
